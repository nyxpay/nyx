...
This mechanism has been integrated into Bitcore-Node-Nyx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nyxpay/insight-api-nyx#web-socket-api](https://github.com/nyxpay/insight-api-nyx#web-socket-api) 
* API: [https://github.com/nyxpay/insight-api-nyx#instantsend-transactions](https://github.com/nyxpay/insight-api-nyx#instantsend-transactions) 
...
By default, the Nyx Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nyx Core daemon:
