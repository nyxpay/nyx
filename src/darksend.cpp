...
{
    if(fLiteMode) return; // ignore all Nyx related functionality
...
/*
    ...
    allow endless transaction that would bloat Nyx and make it unusable. To
...
{
    if(fLiteMode) return; // disable all Nyx specific functionality
