    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nyx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nyx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nyx: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nyx Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nyx Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nyx Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nyx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nyx addresses"));
    ...
    openAction->setStatusTip(tr("Open a nyx: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nyx Core help message to get a list with possible Nyx Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nyx Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nyx network", "", count));
}
...
{
    QString strTitle = tr("Nyx Core"); // default title
