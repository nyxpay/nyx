    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NYX-light"), QVariant("light"));
    ui->theme->addItem(QString("NYX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NYX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NYX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NYX-traditional"), QVariant("trad"));
