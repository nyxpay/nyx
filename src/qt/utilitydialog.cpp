    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Nyx Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Nyx Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  nyx-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Nyx in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NYX, 0.1 NYX, 1 NYX and 10 NYX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nyxpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://nyxpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Nyx Core is shutting down...") + "<br /><br />" +
